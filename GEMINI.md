...
4. **Translation Requirement:** If a transcript is provided in Spanish, a translated English version must be generated and stored in the `transcripts/` folder before assessment. In all cases, if file name convention does not match the below ones, the agent must rename to match. 
5. **Standardized Output:** All assessments must be saved to the `analysis/` folder using the naming convention below. Important: All final reports must follow this template: `docs/AI-Maturity-Assessment-Instruction.md`.
...
5. **Recommend:** Provide 5-10 prioritized recommendations with criticality levels.
